...
class BuildTests(unittest.TestCase):
    ...
    def test_private_phase_clock_is_explicit(self) -> None:
        self.assertIn("30 хвилин у Раунді 1, 45 хвилин у Раунді 2", self.markdowns["ua"])
        self.assertIn("60 хвилин у Раунді 3", self.markdowns["ua"])
        self.assertIn("залишається 5 хвилин і 1 хвилина", self.markdowns["ua"])
        self.assertIn("30 minutes in Round 1, 45 minutes in Round 2", self.markdowns["en"])
